  ...
  return (
    <header className="ito-header">
      ...
      <div className="ito-logo">
        ...
        <span className="ito-logo-name">
          Ito<span>smart</span>
        </span>
      </div>

      {/* Search */}
      <div className="ito-header-center" role="search" aria-label="Search conversations">
      ...
      <div className="ito-header-right">
        <button className="ito-icon-btn" aria-label="Notifications">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" />
            <path d="M13.73 21a2 2 0 0 1-3.46 0" />
          </svg>
        </button>
        <button className="ito-icon-btn" aria-label="Settings">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
